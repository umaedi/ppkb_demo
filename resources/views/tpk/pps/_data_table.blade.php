<table class="table">
    ...
    <tbody>
        ...
        <tr>
            ...
            <td class="text-end"><button data-bs-toggle="modal" data-bs-target="#showDataPps" class="btn btn-sm btn-success"><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-eye" viewBox="0 0 16 16">
