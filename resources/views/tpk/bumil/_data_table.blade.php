<table class="table">
    ...
    <tbody>
        ...
        <tr>
            ...
            <td class="text-end"><button data-bs-toggle="modal" data-bs-target="#showDataBumil" data-id="{{ $tb->id }}" class="btn btn-sm btn-success"><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-eye" viewBox="0 0 16 16">
...
<div class="modal fade modalbox" id="showDataBumil" tabindex="-1" role="dialog">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title">Data Ibu Hamil</h5>
                <a href="javascript:;" data-bs-dismiss="modal">Close</a>
            </div>
            <div class="modal-body">
                <div class="action-sheet-content" id="dataBumilById">
